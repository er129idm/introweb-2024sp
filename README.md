...
**Spring 2024 – Professor Effie J. Rieper**

*Tuesday + Thursday 8:00AM EST - 9:50AM EST*
...
## AI/Machine Learning (ChatGPT Etc)

In this class you are to **_not_** use ChatGPT or any other Machine Learning, Neural Network, AI based content generation: **_not for your code and not for your content_**. This means things like ChatGPT, Microsoft/GitHub CoPilot, etc.

We are here to help *you* learn– not the datasets of these Machines. To develop your abilities and fluency with this medium and not develop the set of training data for OpenAI, etc.
